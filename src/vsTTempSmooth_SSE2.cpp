            ...
            for (int x{0}; x < width; x += 16)
            {
                ...
                if constexpr (fp)
                {
                    compress_saturated_s2u(
                        compress_saturated(
                            truncatei(mul_add(to_float(load<T>(&srcp[_maxr][x])), (1.0f - weights01), sum01 + 0.5f)), zero_si128()),
                        zero_si128())
                        .store_si32(dstp + x);
                    compress_saturated_s2u(
                        compress_saturated(
                            truncatei(mul_add(to_float(load<T>(&srcp[_maxr][x + 4])), (1.0f - weights02), sum02 + 0.5f)), zero_si128()),
                        zero_si128())
                        .store_si32(dstp + (x + 4));
                    compress_saturated_s2u(
                        compress_saturated(
                            truncatei(mul_add(to_float(load<T>(&srcp[_maxr][x + 8])), (1.0f - weights03), sum03 + 0.5f)), zero_si128()),
                        zero_si128())
                        .store_si32(dstp + (x + 8));
                    compress_saturated_s2u(
                        compress_saturated(
                            truncatei(mul_add(to_float(load<T>(&srcp[_maxr][x + 12])), (1.0f - weights04), sum04 + 0.5f)), zero_si128()),
                        zero_si128())
